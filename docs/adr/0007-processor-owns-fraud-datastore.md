...
* **O processor deixa de ser stateless.** Ganha estado próprio para operar, manter, versionar schema de perfil e monitorar. A simplicidade que a ADR 0006 celebrava some.
